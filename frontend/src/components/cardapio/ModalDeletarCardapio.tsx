type ModalDeletarCardapioProps = {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
};

export default function ModalDeletarCardapio({
  isOpen,
  onClose,
  onConfirm,
}: ModalDeletarCardapioProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 bg-opacity-80 flex items-center justify-center z-50 pointer-events-none">
      <div className="bg-white rounded-lg p-6 w-80 shadow-lg pointer-events-auto">
        <p className="mb-6 text-gray-700">Tem certeza que deseja apagar este cardápio?</p>
